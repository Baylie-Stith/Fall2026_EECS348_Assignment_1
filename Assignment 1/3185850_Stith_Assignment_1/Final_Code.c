...
If the user guesses correctly, they win; otherwise, they lose after 3 attempts. This code is a modified version of the
original code Copiolot generated.
Created: 9/6/2026
Edited: 9/8/2026
*/ 
...
int main() {
    ...
    for (attempt = 1; attempt <= 3; attempt++) {
        ...
        if (scanf("%d", &guess) != 1) {
            ...
            attempt--; // Decrement attempt to allow for a valid guess}  
